...
let rubric =
[
  "import_list"^" "^"[true; false]", mptest 1 (ss_pair1 Solution.import_list Student.import_list ([true; false]));
  "filter_sol"^" "^"FunExp(\"x\", (VarExp \"x\"))"^" "^"[true;false]", mptest 1 (ss_pair2 filter_sol filter_stu (FunExp("x", (VarExp "x"))) ([true;false]));
  "num_of_vars"^" "^"IfExp (BinExp (Eq,VarExp \"l\", ConExp Nil), ConExp (Int 0), VarExp \"x\")", mptest 1 (ss_pair1 Solution.num_of_vars Student.num_of_vars (IfExp (BinExp (Eq,VarExp "l", ConExp Nil), ConExp (Int 0), VarExp "x")));
